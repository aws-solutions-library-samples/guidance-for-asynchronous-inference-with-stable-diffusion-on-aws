...
|-----------|------------|------------|------------|------------|
| Amazon EC2 | g5.2xlarge 实例，Spot实例每小时费用  | 416.67 | \$ 0.6003 | \$ 250.16 |
...
| Amazon EC2 | m7g.large 实例，按需实例每小时费用  | 1440 | \$ 0.1008 | \$ 145.15 |
| **小计，每月** | &nbsp; | &nbsp; | &nbsp; | **\$ 217.15** |

- \* 按每个请求耗时 1.5 秒计算，单价参照 2025 年 9 月 4 日 至 2025 年 9 月 11 日 美国西部（俄勒冈）区域所有可用区Spot实例价格之平均值
- \*\* 按请求平均 16 KB 计算
...
- 在当前版本，该解决方案只能在新建的EKS集群上部署，且版本固定为`1.33`。我们会随着Amazon EKS版本发布更新集群版本。
